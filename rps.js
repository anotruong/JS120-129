...
Explicit: 
  ...
  The Classical Appoarch
    -Write a textual description of the problem or exercise
    -Extract the significant nounds and verbs from descrip.
    -Organize and associate the verbs with the nouns. 
      Nouns: Objects, types of objects
      Verbs: behavior, operations
    
Implicit:

The Classical Approach:
  Textual description of the exercise or problem
  ...
  Extract the significant nounds and verbs:
    -Nouns: player, move rule
    -Verbs: chose, compare
      Note: 'rock', 'paper' and 'scissors' is a variation of a move, but each move has a different state so they are considered nouns. 
